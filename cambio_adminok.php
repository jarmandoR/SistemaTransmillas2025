...
if (isset($_POST['param85'])) {
			echo "El checkbox fue marcado";
    ...
    echo "El checkbox NO fue marcado";
}
		# code...			
	break;
	case "Dependencia":
	...
	case "Editar Alarma":
		...
		ECHO$sql1="UPDATE `reportealertas` SET 
		`rep_alerta`='$param2',
		`rep_fechavencimiento`='$param3',
		`rep_emails`='$param4',
		`rep_idsede`='$param1',
		`rep_link_pago`='$param6' $conde WHERE idreportealertas='$id'";
